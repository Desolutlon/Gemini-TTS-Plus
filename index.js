...
import { doExtrasFetch, getApiUrl } from "../../extensions.js";
...
async function callGeminiTTS(text, voice, stylingPrompt, language) {
    ...
    const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-pro-latest:generateContent?key=${settings.apiKey}`;
...
function createSettingsUI() {
    const html = `
        <div class="gemini-tts-settings">
            <h3>Gemini TTS Plus</h3>
...
jQuery(async () => {
    ...
    console.log("[Gemini TTS Plus] Extension loaded");
});
